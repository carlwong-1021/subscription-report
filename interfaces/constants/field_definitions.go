...
var FieldDefinitions []entities.FieldDefinition = []entities.FieldDefinition{
	...
	{func(report *entities.SubscriptionReport) any { return "= (K:K)*(1-W:W)" }, "", "開發者收入"},
	{func(report *entities.SubscriptionReport) any { return "" }, "", "回饋金結算日期"},
	{func(report *entities.SubscriptionReport) any { return "" }, "", "回饋金分潤比例"},
	{func(report *entities.SubscriptionReport) any { return "= W:W * K:K" }, "", "回饋金應付金額"},
	{func(report *entities.SubscriptionReport) any { return "" }, "", "回饋金匯款日期"},
	{func(report *entities.SubscriptionReport) any { return "" }, "", "開立發票日期"},
}
