...
const (
	Events_Create_FullMethodName = "/DeveloperApi.Events/Create"
)
...
type EventsClient interface {
	Create(ctx context.Context, in *Event, opts ...grpc.CallOption) (*EventEmptyResponse, error)
}
...
func (c *eventsClient) Create(ctx context.Context, in *Event, opts ...grpc.CallOption) (*EventEmptyResponse, error) {
	out := new(EventEmptyResponse)
...
type EventsServer interface {
	Create(context.Context, *Event) (*EventEmptyResponse, error)
...
func (UnimplementedEventsServer) Create(context.Context, *Event) (*EventEmptyResponse, error) {
...
func _Events_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EventsServer).Create(ctx, req.(*Event))
	}
...
var Events_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "DeveloperApi.Events",
